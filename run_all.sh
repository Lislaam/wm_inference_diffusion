...
# MAIN LOOP
# -------------------------------------------------------
for env_type in CrazyClimber DemonAttack Freeway Frostbite Gopher Hero Jamesbond Kangaroo Krull KungFuMaster MsPacman Pong PrivateEye Qbert RoadRunner Seaquest UpNDown; do # Alien Amidar Assault Asterix BankHeist BattleZone Breakout ChopperCommand
  for planning_steps in 2 5; do
